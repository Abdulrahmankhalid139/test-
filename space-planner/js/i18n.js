...
const STRINGS = {
  ar: {
    ...
    qWhat: 'الحاجة دي إيه؟',
    qWhatHint: 'اختياري. لو التطبيق عرفها من الصورة مش هتحتاج تكتب — ولو مش عارف، كلامك هو اللي هيمشي.',
    qWhatPh: 'سلة معلقة على المكتب / درج / تسريحة...',
    qPut: 'عايز تحط فيها إيه؟',
    qPutHint: 'اكتبهم بفاصلة. التطبيق يقدّر مقاساتهم لوحده.',
    qPutPh: 'أقلام، هايلايتر، مقص، شاحن...',
    moreOptions: 'خيارات زيادة (مش لازم)',
    handQ: 'بتستخدم أنهي إيد؟',
    answerFirst: 'جاوب على سؤال واحد عالأقل: الحاجة دي إيه، أو عايز تحط فيها إيه.',
    sizeLikeQ: 'قد إيه تقريباً؟',
    sizeKeep: 'سيب المقاس زي ما هو',
    sizeGuessHint: '⚠️ المقاس ده تخمين — مالقيناش في الصورة حاجة مقاسها معروف نقيس عليها. اختار «قد إيه» من تحت أو عدّل الأرقام.',
    b_guessed: '📐 قدّرنا المقاس من شكل المساحة نفسها. مالقيناش مرجع قياس، فالأرقام تقريبية — صلّحها بـ«قد إيه تقريباً».',
    describeTitle: 'أو اوصفها بكلامك',
    describeHint: 'مش لازم صورة. اكتب المساحة دي إيه، قد إيه تقريباً، وعايز تحط فيها إيه — والتطبيق يفهم ويرتّب.',
    describePh: 'دي سلة معلقة على المكتب، حوالي شبر في شبر وارتفاعها شبر، عايزة أحط فيها أقلام وهايلايتر ومقص...',
    describeBtn: '🤖 افهم الوصف ورتّب',
    describeExample: 'التقريب كفاية — «حوالي شبر»، «صغيرة»، «بمقاس علبة مناديل». تقدر تعدّل كل رقم بعد كده.',
    describeNeed: 'اكتب وصف المساحة الأول',
    describeGot: 'فهمنا: {what} — و{n} حاجة. راجع الأرقام قبل الحساب.',
    describeNone: 'مفهمناش الوصف. جرب تقول المساحة دي إيه وقد إيه وعايز تحط فيها إيه.',
    b_described: '✍️ المساحة اتفهمت من وصفك إنت، من غير صورة. الأرقام دي تقديرية — عدّل أي حاجة.',
    photoKept: 'صورتك ظاهرة هنا كمرجع — التطبيق مقدرش يحللها، بس إنت تقدر تبص عليها وإنت بتظبط الأرقام.',
    ...
    photoDrag: '👆 اسحب النقط الأربعة على حواف مساحتك في الصورة — والحاجات هتترص جواها على طول.',
    photoDragHint: 'ظبّط النقط الأربعة على حواف المساحة، وشوف الحاجات وهي بتترص جواها.',
    ...
    undoMove: 'رجّع', resetLayout: 'ترتيب التطبيق',
    moveMode: 'حرّك', removeItem: 'شيل', saveEdit: 'احفظ',
    moveModeOn: '✋ وضع التحريك شغال — دوس على حاجة تمسكها.',
    moveModeOff: 'وضع التحريك اتقفل.',
    pickFirst: 'دوس على حاجة الأول',
    removedOne: 'شيلنا {what}. دوس عليها تحت عشان ترجّعها.',
    restoredOne: 'رجّعنا {what}.',
    removedTitle: 'شيلتهم من المساحة',
    editSaved: 'تعديلاتك اتحفظت ✅',
    tooBigMsg: '⛔ {what} أكبر من المساحة — مش هتدخل مهما حركتها.',
    okHere: '✅ مظبوطة هنا',
    ...
    realImage: '📸 ورّيني الشكل النهائي',
    realImageHint: 'صورة واقعية للترتيب ده — بتتولّد بحسابك وبتكلّف ٢ كريدت.',
    realImageHintEdit: 'هياخد صورتك انت ويحط الحاجات جوّاها بنفس الترتيب المحسوب.',
    fillingPhoto: 'بحط الحاجات في صورتك... ثانية واحدة.',
    needKeyForPhoto: 'عشان أحط الحاجات في صورتك، محتاج مفتاح Gemini مجاني — حطّيه من الإعدادات ⚙️ مرة واحدة.',
    aiImageEdited: 'دي صورتك انت والحاجات متحطّة فيها بالترتيب اللي فوق. الأرقام والمخطط هما الدقيق.',
    img_sending: 'بجهّز الوصف...',
    img_drawing: 'بيرسم الصورة... (نص دقيقة تقريباً)',
    img_notGranted: 'محتاج موافقتك على استخدام الكونيكتور عشان أولّد الصورة.',
    img_noConnector: 'مفيش كونيكتور توليد صور موصّل بحسابك. ضيفه من إعدادات Claude وارجع.',
    img_reauth: 'صلاحية الكونيكتور خلصت — جدّدها من إعدادات Claude.',
    img_blocked: 'الكونيكتور مرفوض بسياسة الحساب.',
    img_busy: 'في ضغط دلوقتي — استنى شوية وجرب تاني.',
    img_timeout: 'الرسم أخد وقت أطول من المتوقع. جرب تاني.',
    img_failed: 'الصورة مطلعتش — جرب تاني.',
    save: 'احفظ', saved: 'محفوظات', open: 'افتح', erase: 'مسح',
    aiImageWarn: '⚠️ دي صورة متولّدة للتخيّل — مش صورتك متعدّلة. الأرقام والمخطط فوق هما الدقيق.',
    rotate: '(لفّها)',
    ...
    t_noImages: 'العرض ده مش بيسمح ببعت صور لـClaude — قيد من المنصة، مش مشكلة في صورتك.',
  ...
  en: {
    ...
    qWhat: 'What is this thing?',
    qWhatHint: 'Optional. If the app works it out from the photo you need not type anything — and if it cannot, your words decide.',
    qWhatPh: 'A basket hanging off my desk / a drawer / a dressing table...',
    qPut: 'What do you want to put in it?',
    qPutHint: 'Separate them with commas. The app estimates their sizes itself.',
    qPutPh: 'pens, highlighters, scissors, charger...',
    moreOptions: 'More options (not required)',
    handQ: 'Which hand do you use?',
    answerFirst: 'Answer at least one: what the thing is, or what you want to put in it.',
    sizeLikeQ: 'Roughly the size of what?',
    sizeKeep: 'Leave the size as it is',
    sizeGuessHint: '⚠️ This size is a guess — we found nothing in the photo of a known size to measure against. Pick a comparison below, or edit the numbers.',
    b_guessed: '📐 We estimated the size from the shape of the space itself. No scale reference was found, so the numbers are approximate — correct them with "roughly the size of what?".',
    describeTitle: 'Or describe it in words',
    describeHint: 'No photo needed. Say what the space is, roughly how big, and what you want to put in it — the app works out the rest.',
    describePh: 'A basket hanging off my desk, about a hand-span square and a span tall, I want to put pens, highlighters and scissors in it...',
    describeBtn: '🤖 Read it and arrange',
    describeExample: 'Rough is fine — "about a span", "small", "the size of a tissue box". You can correct every number afterwards.',
    describeNeed: 'Describe the space first',
    describeGot: 'Understood: {what} — and {n} item(s). Check the numbers before calculating.',
    describeNone: 'We could not read that. Try saying what the space is, how big, and what you want to put in it.',
    b_described: '✍️ The space was understood from your own description, with no photo. These numbers are estimates — correct anything.',
    photoKept: 'Your photo is shown here for reference — the app could not analyse it, but you can look at it while you set the numbers.',
    ...
    photoDrag: '👆 Drag the four dots onto the edges of your space in the photo — the items settle inside as you move them.',
    photoDragHint: 'Put the four dots on the edges of the space, and watch the items land inside it.',
    ...
    undoMove: 'Undo', resetLayout: "App's layout",
    moveMode: 'Move', removeItem: 'Remove', saveEdit: 'Save',
    moveModeOn: '✋ Move mode is on — tap an item to pick it up.',
    moveModeOff: 'Move mode is off.',
    pickFirst: 'Tap an item first',
    removedOne: 'Removed {what}. Tap it below to put it back.',
    restoredOne: '{what} is back.',
    removedTitle: 'Taken out of the space',
    editSaved: 'Your changes are saved ✅',
    tooBigMsg: '⛔ {what} is bigger than the space — it will not fit wherever you move it.',
    okHere: '✅ Fine here',
    ...
    realImage: '📸 Show me how it would look',
    realImageHint: 'A realistic photo of this arrangement — generated on your own account, 2 credits.',
    realImageHintEdit: 'It takes your own photo and puts the things inside it, in the arrangement above.',
    fillingPhoto: 'Putting the things into your photo... one moment.',
    needKeyForPhoto: 'To put the things into your photo I need a free Gemini key — add it once in Settings ⚙️.',
    aiImageEdited: 'This is your own photo with the things placed in it. The numbers and the plan are the exact part.',
    img_sending: 'Writing the description...',
    img_drawing: 'Painting it... (about half a minute)',
    img_notGranted: 'We need your permission to use the connector before generating.',
    img_noConnector: 'No image connector is linked to your account. Add one in Claude settings and come back.',
    img_reauth: 'The connector needs signing in again — do it in Claude settings.',
    img_blocked: 'Your account policy blocks this connector.',
    img_busy: 'Busy right now — wait a moment and try again.',
    img_timeout: 'It took longer than expected. Try again.',
    img_failed: 'The image did not come out — try again.',
    save: 'Save', saved: 'Saved', open: 'Open', erase: 'Delete',
    aiImageWarn: '⚠️ A generated impression, not your photo retouched. The numbers above are the accurate part.',
    rotate: '(turn it)',
    ...
    t_noImages: 'This view cannot send images to Claude — a platform limit, not a problem with your photo.',
