...
const STRINGS = {
  ar: {
    ...
    b_empty: '📦 المساحة دي فاضية — مفيش حاجات نقيسها، فمش محتاجين مرجع قياس. اكتب مقاسها واللي عايز تحطه فيها.',
    emptyTitle: 'المساحة دي فاضية',
    emptyTitleManual: 'قول عايز تحط إيه',
    emptyHintManual: 'اكتب مقاس المساحة فوق، وبعدين قول عايز تحط فيها إيه بجملة عادية — والتطبيق يقولك إيه اللي يدخل وإيه اللي لأ. مش محتاج صورة.',
    emptyHint: 'صوّرت مساحة مفيهاش حاجات — يعني سؤالك مش «رتّبلي اللي موجود» لكن «إيه اللي يدخل هنا؟». اكتب المقاس فوق، وقول عايز تحط إيه.',
    wishPh: 'أقلام، مقص، شاحن...',
    wishBtn: '🤖 هاتهم',
    wishNeed: 'اكتب اللي عايز تحطه الأول',
    wishNone: 'مفهمناش اللي كتبته — جرب تكتبهم مفصولين بفاصلة',
    wishAdded: 'ضفنا {n} حاجة — عدّل أي مقاس قبل الحساب',
    ...
    photoNoImage: 'محتاج صورة عشان نرسم عليها.',
    editHint: 'دوس على أي حاجة تختارها، وبعدين دوس على مكان فاضي تنقلها له، أو على حاجة تانية تبدّلهم.',
    editPicked: 'اخترت {what} — دوس على مكان أو على حاجة تانية.',
    vBetter: '✅ أحسن بـ{n} — وفّرت {cm} سم مد إيد',
    vWorse: '⚠️ أوحش بـ{n}',
    vSame: '= نفس الكفاءة تقريباً',
    vIllegal: '⛔ {why}',
    e_overlaps: 'متراكبة على {what}',
    e_edge: 'قريبة أوي من حرف السطح',
    e_blocks: 'حاجبة {what}',
    e_noRoom: 'مفيش مكان هنا',
    undoMove: 'رجّع خطوة', resetLayout: 'رجّع ترتيب التطبيق',
    fitTitle: '📏 هيدخل ولا لأ؟',
    fitHint: 'حاجة لسه مشتريتهاش — اكتب مقاسها ونقولك هتدخل فين، ولا ناقصك كام سنتي.',
    fitName: 'إيه هي؟ (مثال: شاشة ٢٧ بوصة)',
    fitAsk: '🤖 هات المقاس',
    fitCheck: 'شوف هتدخل ولا لأ',
    fitYes: '✅ هتدخل — مكانها {where}.',
    fitNoRoom: '⚠️ مش هتدخل بالترتيب ده. لو شِلت {what} هتلاقي مكان.',
    fitNoRoomHard: '⚠️ مش هتدخل — مفيش مكان فاضي كفاية.',
    fitTooBig: '⛔ أكبر من المساحة نفسها — ناقصك {w} سم عرض و{d} سم عمق.',
    fitAnchorTaken: '⚠️ مكانها الطبيعي محجوز بـ{what}.',
    fitNeedSize: 'اكتب العرض والعمق الأول',
    spacesTitle: '🗄️ مساحات متصلة',
    spacesHint: 'اللي بيتشال من على السطح بيروح فين؟ ضيف الدرج أو الرف وهنوزّع عليهم.',
    addSpace: '+ ضيف',
    spaceRemove: 'شيل',
    spacesRelocated: '{n} حاجة راحت {where}',
    spacesHomeless: '{n} حاجة مالقتش مكان في أي مساحة.',
    spacesAllPlaced: 'كل حاجة لقت مكان.',
    spacesNeedOne: 'ضيف مساحة واحدة عالأقل',
    handDetected: '🤖 التطبيق شاف إنك بتستخدم إيدك {hand} من الصورة.',
    left: 'الشمال', right: 'اليمين',
    ...
    t_noImages: 'العرض ده مش بيسمح ببعت صور لـClaude — ده قيد من المنصة مش مشكلة في صورتك. ودّيناك للإدخال اليدوي: اكتب المقاس وقول عايز تحط إيه، والباقي هيشتغل عادي.',
  ...
  en: {
    ...
    b_empty: '📦 This space is empty — there is nothing to measure, so no scale reference is needed. Type its size and what you want to put in it.',
    emptyTitle: 'This space is empty',
    emptyTitleManual: 'Say what you want to put in',
    emptyHintManual: 'Type the size of the space above, then say what you want to put in it in a plain sentence — the app tells you what fits and what does not. No photo needed.',
    emptyHint: 'You photographed a space with nothing in it — so your question is not "arrange what is here" but "what fits in here?". Type the size above, and say what you want to put in.',
    wishPh: 'pens, scissors, charger...',
    wishBtn: '🤖 Add them',
    wishNeed: 'Type what you want to put in first',
    wishNone: 'We could not read that — try separating them with commas',
    wishAdded: 'Added {n} item(s) — correct any size before calculating',
    ...
    photoNoImage: 'A photo is needed to draw on.',
    editHint: 'Tap anything to pick it up, then tap an empty spot to move it there, or another item to swap the two.',
    editPicked: '{what} picked up — tap a spot, or another item.',
    vBetter: '✅ Better by {n} — {cm} cm less reaching',
    vWorse: '⚠️ Worse by {n}',
    vSame: '= About the same',
    vIllegal: '⛔ {why}',
    e_overlaps: 'overlapping {what}',
    e_edge: 'too close to the edge',
    e_blocks: 'blocking {what}',
    e_noRoom: 'no room here',
    undoMove: 'Undo', resetLayout: "Back to the app's layout",
    fitTitle: '📏 Will it fit?',
    fitHint: "Something you don't own yet — type its size and we'll tell you where it would go, or how much you're short by.",
    fitName: 'What is it? (e.g. 27-inch monitor)',
    fitAsk: '🤖 Get the size',
    fitCheck: 'Check if it fits',
    fitYes: '✅ It fits — it would go {where}.',
    fitNoRoom: '⚠️ Not with this layout. Remove {what} and it would fit.',
    fitNoRoomHard: '⚠️ It does not fit — not enough free space.',
    fitTooBig: '⛔ Bigger than the space itself — short by {w} cm of width and {d} cm of depth.',
    fitAnchorTaken: '⚠️ Its natural spot is taken by {what}.',
    fitNeedSize: 'Enter the width and depth first',
    spacesTitle: '🗄️ Linked spaces',
    spacesHint: 'Where does what comes off the surface actually go? Add the drawer or the shelf and we will spread things across them.',
    addSpace: '+ Add',
    spaceRemove: 'Remove',
    spacesRelocated: '{n} item(s) moved to {where}',
    spacesHomeless: '{n} item(s) found no home in any space.',
    spacesAllPlaced: 'Everything found a home.',
    spacesNeedOne: 'Add at least one space',
    handDetected: '🤖 The app worked out from the photo that you are {hand}-handed.',
    ...
    t_noImages: 'This view cannot send images to Claude — that is a platform limit, not a problem with your photo. We have switched you to manual entry: type the size and say what you want to put in, and everything else works as normal.',
