...
const ORDER = [
  ...
  'js/homography.js', 'js/render.js', 'js/icons.js', 'js/overlay.js', 'js/edit.js', 'js/multispace.js',
  'js/store.js', 'data/bags.js', 'js/realimage.js', 'js/ai-core.js', AI_MODULE, 'js/app.js',
];
